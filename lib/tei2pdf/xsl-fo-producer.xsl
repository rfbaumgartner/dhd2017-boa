...
<xsl:template match="//term[text()='Plenary']" mode="toc">
  <xsl:if test="(//term[text()='Plenary'])[1] is ."><fo:block><xsl:call-template name="subhead"/>Plenarvorträge</fo:block></xsl:if>
</xsl:template>

<xsl:template match="//term[text()='Workshops']" mode="toc">
  <xsl:if test="(//term[text()='Workshops'])[1] is ."><fo:block><xsl:call-template name="subhead"/>Workshops</fo:block></xsl:if>
</xsl:template>
...
<xsl:template match="//term[text()='Sektion']" mode="toc">
  <xsl:if test="(//term[text()='Sektion'])[1] is ."><fo:block><xsl:call-template name="subhead"/>Sektionen</fo:block></xsl:if>
</xsl:template>

<xsl:template match="//term[text()='Vortrag']" mode="toc">
  <xsl:if test="(//term[text()='Vortrag'])[1] is ."><fo:block><xsl:call-template name="subhead"/>Vorträge</fo:block></xsl:if>
</xsl:template>

<xsl:template match="//term[text()='Poster']" mode="toc">
  <xsl:if test="(//term[text()='Poster'])[1] is ."><fo:block><xsl:call-template name="subhead"/>Poster</fo:block></xsl:if>
</xsl:template>
